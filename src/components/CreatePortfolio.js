...
import CardProfile from './upload-file-component'
				...
				<div className="col-lg-8">
					<div className="card">
						<div className="card-body">
							...
							<div className="row mb-3">
								<div className="col-sm-3">
									<h6 className="mb-0">Official Email</h6>
								</div>
								<div className="col-sm-9 text-secondary">
							...
							<div className="row mb-3">
								...
								<div className="col-sm-9 text-secondary">
									<input type="text" className="form-control"placeholder='Matric/Bachelor/Master' />
								</div>
							</div>
							<div className="row mb-3">
								<div className="col-sm-3">
									<h6 className="mb-0">Experiance</h6>
								</div>
								<div className="col-sm-9 text-secondary">
					...
					<div className="row">
						<div className="col-sm-12">
							<div className="card">
								<div className="card-body">
									<h5 id="d-flex align-items-center mb-3" >Project Status</h5>
									<p>Upload Projects Here:</p>
